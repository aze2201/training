...
--><loginIdentityProviders>
    ...
    <provider>
        ...
        <property name="Password">$2b$12$7Ky35bdVas.RI2dLE2o0yuUPn9sNrVA5hy.dN6z8p84KpxiSHfNa6</property>
    </provider>
    <!--
    ...
    <provider>
      ...
      <class>org.apache.nifi.oauth2.OidcIdentityProvider</class>

      <property name="Discovery URL">https://auth.z-script.io/realms/iot/.well-known/openid-configuration</property>
      <property name="Client ID">nifi</property>
      <property name="Client Secret">xfuGRw9NLRbsmBoxbL2xrJz9chgjTEot</property>
...
nifi@nifi-78f4568dd9-lllzj:/opt/nifi/nifi-current/conf$ 
nifi@nifi-78f4568dd9-lllzj:/opt/nifi/nifi-current/conf$ cat login-identity-providers.xml 
<?xml version="1.0" encoding="UTF-8" standalone="yes"?><!--
  Licensed to the Apache Software Foundation (ASF) under one or more
  contributor license agreements.  See the NOTICE file distributed with
  this work for additional information regarding copyright ownership.
