...
nifi.flowcontroller.registry.sync.interval=30 min
...
nifi.connector.asset.manager.implementation=org.apache.nifi.asset.StandardConnectorAssetManager
nifi.connector.asset.manager.properties.directory=./connector_assets

# Connector Configuration Provider
nifi.connector.configuration.provider.implementation=

# Site to Site properties
nifi.remote.input.host=nifi-558457949b-jbc87
...
# security properties #
nifi.sensitive.props.key=${PROPS_KEY}
...
nifi.cluster.node.address=nifi-558457949b-jbc87
